...
def load_model():
    ...
    checkpoint = torch.load('data/experiments/cater_task2/trn_resnet50/lr01_smallscalejitter_partial/weights/epoch_0082.pth', map_location = "cuda:{}".format(cur_device))
