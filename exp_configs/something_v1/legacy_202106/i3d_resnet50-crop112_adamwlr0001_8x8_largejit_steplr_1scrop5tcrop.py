...
def scheduler(optimiser, iters_per_epoch, last_epoch=-1):
    ...
    return torch.optim.lr_scheduler.StepLR(optimiser, step_size = 100 * iters_per_epoch, gamma = 0.1, last_epoch=last_epoch)     # Here, last_epoch means last iteration.
    #return None
