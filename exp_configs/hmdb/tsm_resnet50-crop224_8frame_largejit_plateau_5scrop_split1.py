...
from model_configs import trn_resnet50 as model_cfg
...
If you want to "actually" run this config file for debug purposes, you can use `cfg = exp_configs.load_cfg('hmdb', 'trn_resnet50', 'crop224_8frame_largejit_plateau_5scrop_split1')`.
"""
import os
