...
FASTTEXT_EXEC_PATH = os.path.join(DATA_DIR, 'nlp', "fasttext")

SNLP_TAGGER_JAR = os.path.join(DATA_DIR, 'nlp', "stanford-postagger.jar")

MODEL_WIKI_UNIGRAMS = os.path.join(DATA_DIR, 'nlp', 'pretrained', 'sent2vec', "wiki_unigrams.bin")
MODEL_WIKI_BIGRAMS = os.path.join(DATA_DIR, 'nlp', 'pretrained', 'sent2vec', "wiki_bigrams.bin")
MODEL_TWITTER_UNIGRAMS = os.path.join(DATA_DIR, 'nlp', 'pretrained', 'sent2vec', "twitter_unigrams.bin")
MODEL_TWITTER_BIGRAMS = os.path.join(DATA_DIR, 'nlp', 'pretrained', 'sent2vec', "twitter_bigrams.bin")
