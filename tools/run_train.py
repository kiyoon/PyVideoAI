...
def add_train_args(parser):
    ...
    parser.add_argument("-P", "--wandb_project", help="Weights & Biases (wandb.ai) project name. Assigning this argument enables the Weights & Biases visualisation service. Make sure you install wandb and call `wandb login` before you use.")
