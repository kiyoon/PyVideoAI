...
import pretrainedmodels.models.torchvision_models
from pretrainedmodels.models.torchvision_models import resnet18, resnet34, resnet50, resnet101, resnet152
import torch
...
def make_temporal_shift(net, n_segment, n_div=8, place="blockres", temporal_pool=False):
    ...
    if isinstance(
        net,
        (torchvision.models.ResNet, resnet18, resnet34, resnet50, resnet101, resnet152),
    ):
        if place == "block":
