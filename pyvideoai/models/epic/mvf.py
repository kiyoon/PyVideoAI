...
from .ops.MVF import make_multi_view_fusion
...
class MVFNet(nn.Module):
    ...
    def __init__(
        ...
        modality,
        mvf_alpha = 0.5,
        mvf_freq = (1,1,1,1),   # whether to insert on res2 to res5
        base_model="resnet50",
        new_length=None,
        consensus_type="avg",
        before_softmax=True,
        ...
        self.mvf_alpha = mvf_alpha
        self.mvf_freq = mvf_freq
        ...
        LOG.info(
            (
                """
Initializing MVFNet with base model: {}.
MVFNet Configurations:
    input_modality:     {}
    num_segments:       {}
    new_length:         {}
    consensus_module:   {}
    ...
    def _prepare_base_model(self, base_model):
        ...
        if "resnet" in base_model.lower():
            ...
            LOG.info("Adding MVF module...")
            make_multi_view_fusion(self.base_model, self.num_segments, self.mvf_alpha, self.mvf_freq)
