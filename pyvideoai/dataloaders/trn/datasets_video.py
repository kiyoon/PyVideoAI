...
def return_something(modality):
    filename_categories = '/disk/scratch1/s1884147/datasets/something-something-v1/trn_meta/category.txt'
    if modality == 'RGB':
        root_data = '/disk/scratch1/s1884147/datasets/something-something-v1/20bn-something-something-v1'
        #root_data = '/mnt/localssd1/bzhou/something/20bn-something-something-v1'
        filename_imglist_train = '/disk/scratch1/s1884147/datasets/something-something-v1/trn_meta/train_videofolder.txt'
        filename_imglist_val = '/disk/scratch1/s1884147/datasets/something-something-v1/trn_meta/val_videofolder.txt'
        prefix = '{:05d}.jpg'
    elif modality == 'Flow':
