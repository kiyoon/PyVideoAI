...
from video_datasets_api.cater.definitions import NUM_CLASSES_TASK1 as num_classes
...
frames_splits_dir = os.path.join(dataset_root, "splits_frames/actions_present")
frames_splits_partial_dir = os.path.join(dataset_root, "splits_frames_partial/actions_present")
