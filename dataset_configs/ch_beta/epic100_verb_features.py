...
RGB_features_pickle_path = {'train': os.path.join(dataset_root, 'features', 'RGB', 'featuers_epoch_0020_traindata_testmode_oneclip.pkl'),
                            'val': os.path.join(dataset_root, 'features', 'RGB', 'featuers_epoch_0020_val_oneclip.pkl'),
        }
